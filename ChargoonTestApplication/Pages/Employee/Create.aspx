<%@ Page Title="" EnableEventValidation="true" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Create.aspx.cs" Inherits="ChargoonTestApplication.Pages.Employee.Create" %>
...
<asp:Content ID="CreateEmployee" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="col-12 button-group">
        <div class="form-group float-md-left">
            ...
            <asp:Button CssClass="btn btn-success" ID="SubmitButton" Text="ثبت اطلاعات" OnClick="SubmitButton_Click" runat="server" />
        </div>
    </div>
</asp:Content>
